                            ...
                            <div class="card-body mx-4 mt-4 resp_mx-0">
                                ...
                                <div class="steps-form-2">
                                    <div class="steps-row-2 setup-panel-2 d-flex justify-content-between">
                                        ...
                                        <div class="steps-step-2">
                                            <a href="#step-2" type="button" class="btn btn-gc-green waves-effect" data-toggle="tooltip" data-placement="top" title="<?php echo translate('Price'); ?>">
                                                <?php echo translate('Price'); ?>
                                            </a>
                                        </div>
                                        <div class="steps-step-2">
                                            <a href="#step-3" type="button" class="btn btn-gc-green waves-effect" data-toggle="tooltip" data-placement="top" title="<?php echo translate('media'); ?>">
                                                <?php echo translate('media'); ?>
                                            </a>
                                        </div>
                                        <div class="steps-step-2">
                                            <a href="#step-4" type="button" class="btn btn-gc-green waves-effect" data-toggle="tooltip" data-placement="top" title="<?php echo translate('seo'); ?>">
                                ...
                                <div class="row setup-content-2" id="step-1">
                                    <div class="col-md-12">
                                        ...
                                        <button class="btn btn-kb-gc btn-rounded nextBtn-2 float-right" type="button"><?php echo translate('next'); ?></button>
                                    </div>
                                </div>
                                ...
                                <div class="row setup-content-2" id="step-2">
                                    <div class="col-md-12">
                                        ...
                                        <button class="btn btn-kb-gc btn-rounded prevBtn-2 float-left" type="button"><?php echo translate('previous'); ?></button>
                                        <button class="btn btn-kb-gc btn-rounded nextBtn-2 float-right" type="button"><?php echo translate('next'); ?></button>
                                    </div>
                                </div>
