                ...
                <div class="card-body">
                    <div class="steps-form-2">
                        <div class="steps-row-2 setup-panel-2 d-flex justify-content-between">
                            ...
                            <div class="steps-step-2">
                                <a href="#step-5" type="button" class="btn btn-gc-green waves-effect" data-toggle="tooltip" data-placement="top" title=" <?php echo translate('social'); ?> <?php echo translate('media'); ?>">
                                    <?php echo translate('social'); ?> <?php echo translate('media'); ?>
                                </a>
                            </div>
                            <div class="steps-step-2">
                                <a href="#step-6" type="button" class="btn btn-gc-green waves-effect" data-toggle="tooltip" data-placement="top" title=" <?php echo translate('media'); ?>">
