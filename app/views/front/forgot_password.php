...
<html lang="en">
    <head>
        ...
        <!--Material Design Bootstrap--><link href="<?php echo $this->config->item('css_url'); ?>online_hiring_advocate.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <!-- SCRIPTS -->
        <!-- knowledge base core JS -->      <script src="<?php echo $this->config->item('js_url'); ?>online_hiring_advocate.js" type="text/javascript"></script>
