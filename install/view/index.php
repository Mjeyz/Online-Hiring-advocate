...
<html lang="en">
    <head>
        ...
        <title>Online Hiring Advocate Installation</title>
        <link href="../assets/css/font-awesome.css" rel="stylesheet">
        <link href="../assets/css/bootstrap.css" rel="stylesheet">
        <link href="../assets/css/online_hiring_advocate.css" rel="stylesheet">
        ...
        <script src="../assets/js/online_hiring_advocate.js"></script>
        ...
        <div class="install-box">
            ...
            <div class="panel panel-install">
                <div class="panel-heading text-center">                    
                    <h2> Online Hiring Advocate Installation </h2>
                ...
                <div class="panel-body no-padding">
                    ...
                    <div class="steps-form-2">
                        <div class="steps-row-2 setup-panel-2 d-flex justify-content-between">
                            ...
                            <div class="steps-step-2">
                                <a id="db_step"  href="#step-2" type="button" class="btn btn-gc-green waves-effect" data-toggle="tooltip" data-placement="top" title="Personal Data">
                                    Configuration
                                </a>
                            </div>
                            <div class="steps-step-2">
                                <a id="site_step" href="#step-3" type="button" class="btn btn-gc-green waves-effect" data-toggle="tooltip" data-placement="top" title="Terms and Conditions">
                                    Site Setting
                                </a>
                            </div>
                            <div class="steps-step-2">
                                <a id="email_step" href="#step-4" type="button" class="btn btn-gc-green waves-effect mr-0" data-toggle="tooltip" data-placement="top" title="Finish">
                                    Email Setting
                                </a>
                            </div>
                        </div>
                    ...
                    <form name="config-form" id="config-form" action="do_install.php" method="post" enctype="multipart/form-data">
                        <div class="row setup-content-2" id="step-1">
                            ...
                            <div class="section">
                                ...
                                ?> class="btn btn-kb-gc btn-rounded nextBtn-2 float-right" type="button">Next</button>
                            </div>
                        </div>
                        <div class="row setup-content-2" id="step-2">
                            ...
                            <div class="section clearfix">
                                ...
                                <button class="btn btn-kb-gc btn-rounded prevBtn-2 float-left" type="button">Previous</button>
                                <button class="btn btn-kb-gc btn-rounded nextBtn-2 float-right" type="button">Next</button>
                            </div>
                        </div>
            ...
            $(document).ready(function () {
                ...
                navListItems.click(function (e) {
                    ...
                    if (!$item.hasClass('disabled')) {
                        navListItems.removeClass('btn-amber').addClass('btn-gc-green');
